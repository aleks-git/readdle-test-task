/** 
 * Mosaico - OpenSource Email Template Editor - v0.17.1 - 2019-05-18 
...
},{"slick/parser":22}],13:[function(require,module,exports){
...
},{"./property":11,"./selector":12,"mensch":16}],14:[function(require,module,exports){
(function (global){
...
},{"./support/isBuffer":26,"_process":21,"inherits":25}],28:[function(require,module,exports){
(function (global){
...
},{"./ext/color.js":60,"./ext/inliner.js":61,"./ext/localstorage.js":62,"./ext/util.js":63,"./ko-bindings.js":64,"./template-loader.js":65,"./timed-call.js":66,"./undomanager/undomain.js":67,"console-browserify":6}],29:[function(require,module,exports){
(function (global){
...
},{"./string-template.js":45}],32:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6,"knockout-sortable":14}],38:[function(require,module,exports){
(function (global){
"use strict";var $="undefined"!=typeof window?window.jQuery:"undefined"!=typeof global?global.jQuery:null,ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,console=require("console-browserify");ko.bindingHandlers.preloader={init:function(e,o){var i=o();if(void 0===i.preloaded){i.preloaded=ko.observable("");var r=function(e){if(e!=i.preloaded())if(""!==e){var o=new Image;o.onload=function(){i.preloaded(e)},o.onerror=function(){i.preloaded(e)},o.src=e}else i.preloaded(e)};i.subscribe(r),r(i())}}},ko.bindingHandlers.advattr={init:function(e,o,i,r,l){var a=ko.utils.unwrapObservable(o()||{});ko.utils.objectForEach(a,function(o,i){var r=e.getAttribute(o);if(ko.isWriteableObservable(i)){var l=i();l!=r&&(i(r),null!==l&&console.log("AdvAttr found a value different from the default",o,l,r))}})},update:function(e,o,i){var r=ko.utils.unwrapObservable(o())||{};ko.utils.objectForEach(r,function(o,i){!1===(i=ko.utils.unwrapObservable(i))||null==i?e.removeAttribute(o):e.setAttribute(o,i.toString())})}},ko.bindingHandlers.advstyle={init:function(e,o,i,r,l){var a=ko.utils.unwrapObservable(o()||{});ko.utils.objectForEach(a,function(o,i){var r;if(o.match(/Px$/)?(o=o.substr(0,o.length-2),(r=e.style[o]).match(/px$/)?r=r.replace(/px$/,""):console.log("AdvStyle binding found an unexpected default value",o,r,e)):r=e.style[o],ko.isWriteableObservable(i)){var l=i();l!=r&&(i(r),null!==l&&console.log("AdvStyle found a value different from the default",o,l,r))}})},update:function(e,o){var i=ko.utils.unwrapObservable(o()||{});ko.utils.objectForEach(i,function(o,i){null!=(i=ko.utils.unwrapObservable(i))&&!1!==i||(i=""),o.match(/Px$/)&&(o=o.substr(0,o.length-2),i+="px"),e.style[o]=i})}},ko.bindingHandlers.domlog={init:function(e,o){console.log("initialized",e),ko.utils.domNodeDisposal.addDisposeCallback(e,function(){console.log("disposed",e)})}},ko.bindingHandlers.fudroppable={init:function(e,o){var i=o()||{},r={},l=function(e,o,i,r,l,a){e[o]?global.clearTimeout(e[o]):(void 0!==r&&i.classList.add(r),ko.isWriteableObservable(l)&&!l()&&l(!0));var n=function(){e[o]=null,void 0!==r&&i.classList.remove(r),ko.isWriteableObservable(l)&&l()&&l(!1)};"dragleave"==a.type?n():e[o]=global.setTimeout(n,500)};(i.active||i.activeClass)&&ko.utils.registerEventHandler(global,"dragover",l.bind(void 0,r,"activeTimeout",e,i.activeClass,i.active)),i.hoverClass&&ko.utils.registerEventHandler(e,"dragover dragenter dragleave",l.bind(void 0,r,"hoverTimeout",e,i.hoverClass,void 0))}},ko.bindingHandlers.fileupload={extendOptions:{},remoteFilePreprocessor:function(e){return e},init:function(e,o){ko.utils.domNodeDisposal.addDisposeCallback(e,function(){$(e).fileupload("destroy")}),"WebkitAppearance"in global.document.documentElement.style?$(e).attr("title"," "):$(e).attr("title","")},update:function(e,o){var i=o()||{},r=$(e),l=r.parents(".uploadzone"),a=i.data;i.data=void 0;var n=i.canvasPreview;ko.utils.extend(i,{url:"/upload/",dataType:"json",dropZone:l.find(".mo-uploadzone")[0],autoUpload:!0,acceptFileTypes:/(\.|\/)(gif|jpe?g|png)$/i,maxFileSize:1048576,disableImageResize:/Android(?!.*Chrome)|Opera/.test(global.navigator.userAgent),previewMaxWidth:200,previewMaxHeight:200,previewCrop:!1,replaceFileInput:!1,messages:{unknownError:"Unknown error",uploadedBytes:"Uploaded bytes exceed file size",maxNumberOfFiles:"Maximum number of files exceeded",acceptFileTypes:"File type not allowed",maxFileSize:"File is too large",minFileSize:"File is too small",post_max_size:"The uploaded file exceeds the post_max_size directive in php.ini",max_file_size:"File is too big",min_file_size:"File is too small",accept_file_types:"Filetype not allowed",max_number_of_files:"Maximum number of files exceeded",max_width:"Image exceeds maximum width",min_width:"Image requires a minimum width",max_height:"Image exceeds maximum height",min_height:"Image requires a minimum height",abort:"File upload aborted",image_resize:"Failed to resize image",generic:"Unexpected upload error"}}),ko.utils.extend(i,ko.bindingHandlers.fileupload.extendOptions);var t=0,s="",d=function(){0==--t&&(a&&a(s),s="",n&&(l.find("img").show(),l.find("canvas").remove()),l.removeClass("uploading"),l.find(".progress-bar").css("width",0))},u=function(e){if("object"==typeof i.messages&&null!==i.messages){var o=e.match(/^([^ ]+)(.*)$/);if(o&&void 0!==i.messages[o[1]])return i.messages[o[1]]+o[2]}return e};r.fileupload(i);for(var f=["fileuploadadd","fileuploadprocessalways","fileuploadprogressall","fileuploaddone","fileuploadfail"],p=function(e,o){if("fileuploadadd"==e.type&&t++,"fileuploadfail"==e.type&&(console.log("fileuploadfail",e,o),i.onerror&&(""===o.errorThrown&&"error"==o.textStatus?i.onerror(u("generic")):i.onerror(u("generic ("+o.errorThrown+")"))),d()),"fileuploaddone"==e.type)if(void 0!==o.result.files[0].url){if(i.onfile)for(var r=0;r<o.result.files.length;r++)o.result.files[r]=ko.bindingHandlers.fileupload.remoteFilePreprocessor(o.result.files[r]),i.onfile(o.result.files[r]);if(""===s&&(s=o.result.files[0].url),n){var a=new Image;a.onload=d,a.onerror=d,a.src=o.result.files[0].url}else d()}else void 0!==o.result.files[0].error?(console.log("remote error",e,o),i.onerror&&i.onerror(u(o.result.files[0].error)),d()):(console.log("unexpected error",e,o),i.onerror&&i.onerror(u("generic (Unexpected Error retrieving uploaded file)")),d());if("fileuploadprocessalways"==e.type){var f=o.index,p=o.files[f];if(p.preview&&0===f&&0===l.find("canvas").length){if(n){var c=$(p.preview).css("width","100%");l.find("img").hide(),l.prepend(c)}l.addClass("uploading"),l.find(".progress-bar").css("width",0)}p.error&&(i.onerror&&i.onerror(u(p.error)),d())}if("fileuploadprogressall"==e.type){var v=parseInt(o.loaded/o.total*100,10);l.find(".progress-bar").css("width",v+"%")}},c=f.length-1;c>=0;c--){var v=f[c];r.on(v,p)}$.support.fileInput||r.prop("disabled",!0).parent().addClass("disabled")}};
...
},{"console-browserify":6}],44:[function(require,module,exports){
(function (global){
...
},{"./script-template.js":42}],46:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6}],47:[function(require,module,exports){
(function (global){
...
(function (global){
"use strict";var tinymce="undefined"!=typeof window?window.tinymce:"undefined"!=typeof global?global.tinymce:null,$="undefined"!=typeof window?window.jQuery:"undefined"!=typeof global?global.jQuery:null,ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,console=require("console-browserify");require("./eventable.js"),ko.bindingHandlers.wysiwygOrHtml={init:function(e,t,i,n,o){return void 0===o.templateMode||"wysiwyg"!=o.templateMode?ko.bindingHandlers.virtualHtml.init():ko.bindingHandlers.wysiwyg.init(e,t,i,n,o)},update:function(e,t,i,n,o){if(void 0===o.templateMode||"wysiwyg"!=o.templateMode)return ko.bindingHandlers.virtualHtml.update(e,t,i,n,o)}},ko.virtualElements.allowedBindings.wysiwygOrHtml=!0,ko.bindingHandlers.wysiwygHref={init:function(e,t,i,n,o){8!==e.nodeType&&(t(),void 0===o.templateMode||"wysiwyg"!=o.templateMode?e.setAttribute("target","_new"):void 0!==i().wysiwygOrHtml?e.setAttribute("href","javascript:void(0)"):(e.removeAttribute("href"),e.setAttribute("disabledhref","#")))},update:function(e,t,i,n,o){if(8!==e.nodeType){var l=void 0===o.templateMode||"wysiwyg"!=o.templateMode,r=ko.utils.unwrapObservable(t());l&&(!1===r||null==r?e.removeAttribute("href"):e.setAttribute("href",r.toString()))}}},ko.virtualElements.allowedBindings.wysiwygHref=!0,ko.bindingHandlers.wysiwygSrc={convertedUrl:function(e,t,i,n){var o=-1==e.indexOf("?")?"?":"&";return e+o+"method="+t+"&width="+i+(null!==n?"&height="+n:"")},placeholderUrl:function(e,t,i){},update:function(e,t,i,n,o){var l=ko.utils.unwrapObservable(t()),r=ko.utils.unwrapObservable(l.src),s=ko.utils.unwrapObservable(l.placeholder),d=ko.utils.unwrapObservable(l.width),a=ko.utils.unwrapObservable(l.height);if(!1===r||null==r||""===r)"object"==typeof s&&null!==s?e.setAttribute("src",ko.bindingHandlers.wysiwygSrc.placeholderUrl(s.width,s.height,s.text)):e.removeAttribute("src");else{var u=ko.utils.unwrapObservable(l.method);u||(u=d>0&&a>0?"cover":"resize");var g=ko.bindingHandlers.wysiwygSrc.convertedUrl(r.toString(),u,d,a);e.setAttribute("src",g)}null!=d?e.setAttribute("width",d):e.removeAttribute("width"),null!=a?e.setAttribute("height",a):e.removeAttribute("height")}},ko.bindingHandlers.wysiwygId={init:function(e,t,i,n,o){void 0===o.templateMode||"wysiwyg"!=o.templateMode||e.setAttribute("id",ko.utils.unwrapObservable(t()))},update:function(e,t,i,n,o){void 0===o.templateMode||"wysiwyg"!=o.templateMode||e.setAttribute("id",ko.utils.unwrapObservable(t()))}},ko.virtualElements.allowedBindings.wysiwygId=!0,ko.bindingHandlers.wysiwygClick={init:function(e,t,i,n,o){void 0===o.templateMode||"wysiwyg"!=o.templateMode||ko.bindingHandlers.click.init(e,t,i,n,o)}},ko.virtualElements.allowedBindings.wysiwygClick=!0,ko.bindingHandlers.wysiwygCss={update:function(e,t,i,n,o){void 0===o.templateMode||"wysiwyg"!=o.templateMode||ko.bindingHandlers.css.update(e,t,i,n,o)}},ko.virtualElements.allowedBindings.wysiwygCss=!0,ko.bindingHandlers.wysiwygImg={makeTemplateValueAccessor:function(e,t){return function(){var i=void 0!==t.templateMode&&"wysiwyg"==t.templateMode,n=e(),o=ko.utils.peekObservable(n);return ko.utils.unwrapObservable(n),{name:i?o._editTemplate:o._template,templateEngine:ko.nativeTemplateEngine.instance}}},init:function(e,t,i,n,o){return ko.bindingHandlers.template.init(e,ko.bindingHandlers.wysiwygImg.makeTemplateValueAccessor(t,o))},update:function(e,t,i,n,o){return o=o.extend(t()),ko.bindingHandlers.template.update(e,ko.bindingHandlers.wysiwygImg.makeTemplateValueAccessor(t,o),i,n,o)}},ko.virtualElements.allowedBindings.wysiwygImg=!0;var _catchingFire=function(e,t){try{return this.originalFire.apply(this,arguments)}catch(t){console.warn("Cought tinymce exception while firing editor event",e,t)}};ko.bindingHandlers.wysiwyg={debug:!1,currentIndex:0,standardOptions:{},fullOptions:{toolbar1:"bold italic forecolor backcolor hr styleselect removeformat | link unlink | pastetext code",plugins:["link hr paste lists textcolor code"]},init:function(e,t,i,n,o){ko.bindingHandlers.focusable.init(e);var l=ko.bindingHandlers.wysiwyg.debug&&"function"==typeof console.debug,r=e.getAttribute("id");r||(r="wysiwyg_"+ ++ko.bindingHandlers.wysiwyg.currentIndex,e.setAttribute("id",r)),ko.utils.domNodeDisposal.addDisposeCallback(e,function(){l&&console.debug("Editor for selector",r,"is being removed..."),tinymce.remove("#"+e.getAttribute("id")),l&&console.debug("Editor for selector",r,"has been removed.")});var s=t();if(!ko.isObservable(s))throw"Wysiwyg binding called with non observable";if(8===e.nodeType)throw"Wysiwyg binding called on virtual node, ignoring...."+e.innerHTML;var d,a="DIV"==e.tagName||"TD"==e.tagName,u=!1,g=!1,c={selector:"#"+r,inline:!0,hidden_input:!1,plugins:["paste"],toolbar1:"bold italic",toolbar2:"",preview_styles:!1,paste_as_text:!0,language:"en",schema:"html5",extended_valid_elements:"strong/b,em/i,*[*]",menubar:!1,skin:"gray-flat",forced_root_block:a?"p":"",init_instance_callback:function(e){l&&console.debug("Editor for selector",r,"is now initialized.")},setup:function(e){l&&console.debug("Editor for selector",r,"is now in the setup phase."),e.on("change redo undo",function(){u||(g=!0,s(e.getContent({format:"raw"})),g=!1)}),e.on("focus",function(){e.nodeChanged(),e.getElement().click()}),e.on("BeforeSetContent",function(e){e.initial&&(e.format="raw")}),void 0===e.originalFire&&(e.originalFire=e.fire,e.fire=_catchingFire),d=e}};return ko.utils.extend(c,ko.bindingHandlers.wysiwyg.standardOptions),a&&ko.utils.extend(c,ko.bindingHandlers.wysiwyg.fullOptions),global.setTimeout(function(){l&&console.debug("Editor for selector",r,"is being inizialized ...");var e=tinymce.init(c);l&&console.debug("Editor for selector",r,"init has just been called returning",e),e.then(function(){l&&console.debug("Editor for selector",r,"init promise has resolved.")},function(e){console.log("Editor for selector",r,"init promise has failed.",e)})}),ko.computed(function(){var i=ko.utils.unwrapObservable(t());if(!g){try{u=!0,void 0!==d?d.setContent(i,{format:"raw"}):ko.utils.setHtml(e,i)}catch(e){console.warn("Exception setting content to editable element",typeof d,e)}u=!1}},null,{disposeWhenNodeIsRemoved:e}),{controlsDescendantBindings:!0}}};

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./eventable.js":34,"console-browserify":6}],50:[function(require,module,exports){
...
},{"console-browserify":6}],51:[function(require,module,exports){
...
},{"./domutils.js":52,"./utils.js":58,"console-browserify":6,"mensch/lib/parser.js":19}],52:[function(require,module,exports){
(function (global){
...
},{"./declarations.js":51,"./model.js":55,"./utils.js":58,"console-browserify":6}],54:[function(require,module,exports){
...
},{"./checkmodel.js":50,"./editor.js":53,"./model.js":55,"./parser.js":56,"./wrapper.js":59}],55:[function(require,module,exports){
...
},{"./declarations.js":51,"./utils.js":58,"console-browserify":6,"mensch/lib/parser.js":19}],58:[function(require,module,exports){
...
},{"console-browserify":6,"jsep":9}],59:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6}],60:[function(require,module,exports){
(function (global){
...
},{"tinycolor2":23}],61:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6,"juice/lib/inline":10}],62:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6}],63:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6}],67:[function(require,module,exports){
(function (global){
...
},{"./undomanager.js":68,"./undoserializer.js":69}],68:[function(require,module,exports){
(function (global){
...
},{"console-browserify":6,"ko-reactor/dist/ko-reactor.min.js":15}],69:[function(require,module,exports){
(function (global){
